...
export const checkList = (link: string) => {
    switch (link) {
        ...
        case 'correntes-%7C-acessorios': return listaDeAcessoriosCorrentes
        case 'lacos-de-cabo-de-aco': return listaDeLacosDeCabos
        case 'cintas-de-poliester-%7C-elevacao': return listaDeCintasElevacao
        case 'cintas-de-poliester-%7C-amarracao': return listaDeCintasAmarracao
        case 'equipamentos': return listaDeEquipamentos
    }
}
